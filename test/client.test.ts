...
describe('VeloraClient', () => {
  ...
  const originalVeloraUrl = (globalThis as any).VELORA_API_URL
  ...
  afterAll(() => {
    if (originalVeloraUrl) (globalThis as any).VELORA_API_URL = originalVeloraUrl
  })
  ...
  describe('constructor', () => {
    ...
    it.skip('should throw error if no fetch available', () => {
      ...
      expect(() => new VeloraClient({ apiKey: 'test-key' })).toThrow('No fetch available')
  ...
  describe('listJobs', () => {
    it('should list jobs with default parameters', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs',
    ...
    it('should list jobs with status filter', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs?status=active',
    ...
    it.skip('should list jobs with folder_path filter', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs?folder_path=%2Freports%2F',
        expect.objectContaining({ method: 'GET' })
      )
    })
  ...
  describe('getJob', () => {
    it('should get a single job by ID', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1',
        expect.objectContaining({ method: 'GET' })
      )
  ...
  describe('bulkGetJobs', () => {
    it.skip('should bulk fetch jobs by IDs', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/bulk',
        expect.objectContaining({
          method: 'POST',
  ...
  describe('pauseJob', () => {
    it('should pause a job', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1/pause',
  ...
  describe('resumeJob', () => {
    it('should resume a paused job', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1/resume',
        expect.objectContaining({ method: 'POST' })
      )
  ...
  describe('triggerJob', () => {
    it('should trigger a job for immediate execution', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1/trigger',
        expect.objectContaining({ method: 'POST' })
      )
  ...
  describe('regenerateWebhookSecret', () => {
    it('should regenerate webhook secret', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1/regenerate-webhook-secret',
        expect.objectContaining({ method: 'POST' })
      )
  ...
  describe('listJobRuns', () => {
    it('should list job runs with default parameters', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1/runs',
        expect.objectContaining({ method: 'GET' })
      )
    ...
    it('should list job runs with limit and offset', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/jobs/job-1/runs?limit=10&offset=5',
        expect.objectContaining({ method: 'GET' })
      )
  ...
  describe('getUsage', () => {
    it('should get usage information', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/usage',
        expect.objectContaining({ method: 'GET' })
      )
  ...
  describe('getPlan', () => {
    it('should get plan information', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/plan',
        expect.objectContaining({ method: 'GET' })
      )
      expect(result).toEqual({
        subscription: null,
  ...
  describe('triggerWebhook', () => {
    it('should trigger a public webhook', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        'https://velora-api.psalinks.com/api/v1/webhooks/job-1',
        expect.objectContaining({
          method: 'POST',
